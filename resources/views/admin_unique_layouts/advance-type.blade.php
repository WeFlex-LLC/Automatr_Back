...
<html lang="en">
  <head>
    ...
    <title>Cuba - Premium Admin Template - Barcelona</title>
    <!-- Google font-->
  ...
  <body>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='landing-page' ? 'active' : '' }}" href="{{route('landing-page')}}"><i data-feather="cast"> </i><span>{{ trans('lang.Landing Page') }}</span></a></li>
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Chart (Barcelona)</li>
                  </ol>
                </div>
              </div>
            </div>
    ...
    <script type="text/javascript"> 
        $('.other').hide();
        localStorage.clear();
        $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper enterprice-type advance-layout");
